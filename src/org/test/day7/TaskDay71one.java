...
public class TaskDay71one {
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		txtfashion.click();
		Thread.sleep(2000);
		WebElement txtwomen = driver.findElement(By.xpath("//span[text()='Women']"));
		Thread.sleep(2000);
		Actions ac = new Actions(driver);
		ac.moveToElement(txtwomen).perform();
		Thread.sleep(2000);
		TakesScreenshot ts = (TakesScreenshot) driver;
		File screenshotAs = ts.getScreenshotAs(OutputType.FILE);
		File f = new File("C:\\Users\\Dinesh\\Pictures\\Camera Roll\\dineshsample8.png");
